...
import DigiBirdLightBox from 'components/common/DigiBirdLightBox';
import DigiBirdLightBoxGallery from 'components/common/DigiBirdLightBoxGallery';
          ...
          >
            ...
            {message.attachments ? (
              <div className="chat-message chat-gallery">
                ...
                <DigiBirdLightBoxGallery images={message.attachments}>
                  {setImgIndex => (
                    <Row className="mx-n1">
              ...
              <>
                ...
                >
                  ...
                  {message.attachment && (
                    <DigiBirdLightBox image={message.attachment}>
                      <Image
                        fluid
                        rounded

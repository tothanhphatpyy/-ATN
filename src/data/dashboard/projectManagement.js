...
export const managementEvents = [
  {
    id: uuid(),
    title: `Monthly team meeting for DigiBird React Project`,
...
export const recentActivities = [
  ...
  {
    id: 2,
    title: 'DigiBird v3.0.0 released with new features',
    text: 'DigiBird new version is released successfully with new Dashboards',
    icon: 'code',
    time: '1h ago',
    status: 'current'
  },

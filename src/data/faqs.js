...
export const faqs = [
  {
    id: 0,
    title: `How does DigiBird's pricing work?`,
    description: `The free version of DigiBird is available for teams of up to 15 people. Our DigiBird Premium plans of 15 or fewer qualify for a small team discount. As your team grows to 20 users or more and gets more value out of DigiBird, you'll get closer to our standard monthly price per seat. The price of a paid DigiBird plan is tiered, starting in groups of 5 and 10 users, based on the number of people you have in your Team or Organization.`
  },
  {
    id: 1,
    title: 'What forms of payment do you accept?',
    description: `You can purchase DigiBird with any major credit card. For annual subscriptions, we can issue an invoice payable by bank transfer or check. Please contact us to arrange an invoice purchase. Monthly purchases must be paid for by credit card.`
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: `We're happy to work with student groups using DigiBird. Contact Us`
  },
  {
    id: 7,
    title: `Is there an on-premise version of DigiBird?`,
    description: `We are passionate about the web. We don't plan to offer an internally hosted version of DigiBird. We hope you trust us to provide a robust and secure service so you can do the work only your team can do.`
  },
  {
    id: 8,
...
export const faqDoc = [
  {
    id: 1,
    title: 'How to start working with DigiBird React',
    ...
    You will get 2 files in the folder. Now unzip the <code>digibird-react-${version}</code> directory and open this directory from your terminal.
    Run <code>npm install </code> from your terminal.
    After installing all the required packages, run <code>npm start</code>. <br>
    Please check the following link to see How to Getting started in DigiBird React: <a target='_blank' href='//${homepage}/documentation/getting-started'>${homepage}/documentation/getting-started<a/>.</p>`
  },
  {
    id: 2,
    title:
      'Is there a specific version of Node.js I should use for DigiBird React?',
  ...
  },
  {
    ...
    description: `<p class="mb-0">We used the <b>reactstrap</b> for DigiBird React <code>v2.x</code> and <b>React bootstrap</b> for DigiBird React <code>v3.x</code>.</p>`
  },
  {
    id: 6,
    title: 'Where will I get the Figma Files?',
    description: `<p >You will find the Figma link in the <code>README.md</code> file on your downloaded copy of DigiBird. Here is the detailed documentation: <a target='_blank' href='//${homepage}/documentation/design-file'> ${homepage}/documentation/design-file</a>.</p>
    <p class='mb-0'>If you still have any problem with the link, reach us out with your purchase ID at <a href="mailto:support@digibird.com">support@digibird.com</a></p>`
  },
  {
    id: 7,
    title:
      'What are the bare minimum files just to get the layout and navigation?',
    description: `<p >You can start from the DigiBird’s Starter page where the minimum required components are included to get layout and navigation.
    ...
    <p class="mb-0">We have created a mini version of DigiBird React with all the essential files only. If you are interested, please reach us out with your purchase ID at <a href="mailto:support@digibird.com">support@digibird.com</a>.
    </p>`
  },
  {
    id: 8,
    title: 'How to compile SCSS files with DigiBird React?',
    description: `<p class="mb-0">To compile scss files in DigiBird react run npm run <code>build:css</code> from your terminal, or you can watch the scss files by running npm run <code>watch:css</code> to a separate terminal. 
    Check the link below to have a look on the styling documentation in DigiBird React <a target='_blank' href='//${homepage}/documentation/styling'> ${homepage}/documentation/styling</a>
    </p>`
  },
  {
    id: 9,
    title: 'How to update from DigiBird React v2.x to the upper version?',
    ...
    So, it would be better to start building applications with the Bootstrap 5 version of DigiBird from scratch. You can include any components from your existing project to your current project. Bring the component and its required SCSS and place it into your current project.
    </p>`
  }
];
